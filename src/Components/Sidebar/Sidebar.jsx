      ...
      <div className="shortcut-links">
        ...
        <div className="subscribed-list">
            ...
            <div className={`side-link`}>
              <Link to="https://www.youtube.com/@PewDiePie"><img className="iconh" src={jack} alt="" /></Link>
              <Link to="https://www.youtube.com/@PewDiePie"><p className="para">PewDiePie</p></Link>
            </div>

            <div className={`side-link`}>
            <Link to="https://www.youtube.com/@MrBeast"><img className='iconh' src={simon} alt="" /></Link>
            <Link to="https://www.youtube.com/@MrBeast"><p className="para">MrBeast</p></Link>
            </div>

            <div className={`side-link`}>
            <Link to="https://www.youtube.com/@justinbieber"><img className='iconh' src={tom} alt="" /></Link>
            <Link to="https://www.youtube.com/@justinbieber"><p className="para">Justin Bieber</p></Link>
            </div>

            <div className={`side-link`}>
            <Link to="https://www.youtube.com/@5MinuteCraftsYouTube"><img className='iconh' src={megan} alt="" /></Link>
            <Link to="https://www.youtube.com/@5MinuteCraftsYouTube"><p className="para">5-Minute Crafts</p></Link>
            </div>

            <div className={`side-link`}>
            <Link to="https://www.youtube.com/@NasDaily"><img className='iconh' src={cameron} alt="" /></Link>
            <Link to="https://www.youtube.com/@NasDaily"><p className="para">Nas Daily</p></Link>  
            </div>
        </div>
    </div>
  )
